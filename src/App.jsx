...
import { Home, Heart, HeartHandshake, ListOrdered, LogOut, ShieldCheck } from 'lucide-react';
  ...
  return (
    <div className="app-container">
      <aside className="sidebar">
        ...
        <div style={{ marginTop: 'auto', display: 'flex', flexDirection: 'column', gap: '1rem', borderTop: '1px solid var(--border)', paddingTop: '2rem' }}>
